...
class ray {
  public:
    ...
    __host__ __device__ ray(const point3& origin, const vec3& direction, real_t time)
    ...
    __host__ __device__ real_t time() const { return tm; }

    __host__ __device__ point3 at(real_t t) const {
        return orig + t*dir;
    }
